...
/* const char *filemode_string(const unsigned char *); */
/* in lisp.h? */
extern Lisp_Object filemode_string(Lisp_Object);
extern Lisp_Object file_attributes(Lisp_Object, Lisp_Object);
/* gb extern Lisp_Object file_attributes_internal (int fd, char const *name, */
/* 		 Lisp_Object dirname, Lisp_Object filename, */
/* 		 Lisp_Object id_format); */
extern Lisp_Object file_attributes_internal (Lisp_Object dirname,
...
# endif	 /* !WINDOWSNT */
  ...
  for (struct dirent *dp; (dp = read_dirent (d, directory)); )
      ...
      if (wanted)
	{
	  ...
	  if (attrs)
	    {
	      /* gb Lisp_Object fileattrs */
	      /* 	= file_attributes_internal (fd, dp->d_name, directory, */
	      /* 				    name, id_format); */
	      Lisp_Object fileattrs
		= file_attributes_internal (directory, name, id_format);
