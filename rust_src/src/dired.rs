...
#[cfg(unix)]
use dired_unix::{directory_files_intro, file_attributes_intro, get_users};
#[cfg(windows)]
...
pub fn directory_files(
    ...
    directory_files_intro(directory, full, match_re, nosort, false, Qnil)
}
...
pub fn directory_files_and_attributes(
    ...
    directory_files_intro(directory, full, match_re, nosort, true, id_format)
}
